    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-[#2A2A30] bg-[#0B0B0D]/95 p-6 text-white backdrop-blur-xl md:w-[390px]">
              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                    ...
                    {cart.lines
                      ...
                      .map((item, i) => {
                        ...
                        return (
                          <li
                            key={i}
                            className="flex w-full flex-col border-b border-[#2A2A30]"
                          >
                            <div className="relative flex w-full flex-row justify-between px-1 py-4">
                              ...
                              <div className="flex flex-row">
                                <div className="relative h-16 w-16 overflow-hidden rounded-md border border-[#2A2A30] bg-[#141418]">
                                  <Image
                              ...
                              <div className="flex h-16 flex-col justify-between">
                                ...
                                />
                                <div className="ml-auto flex h-9 flex-row items-center rounded-full border border-[#2A2A30]">
                  ...
                  <div className="py-4 text-sm text-neutral-400">
                    <div className="mb-3 flex items-center justify-between border-b border-[#2A2A30] pb-1">
                      <p>MwSt.</p>
                      <Price
                    ...
                    <div className="mb-3 flex items-center justify-between border-b border-[#2A2A30] pb-1 pt-1">
                      <p>Versand</p>
                      <p className="text-right">Wird an der Kasse berechnet</p>
                    </div>
                    <div className="mb-3 flex items-center justify-between border-b border-[#2A2A30] pb-1 pt-1">
                      <p>Gesamt</p>
                      <Price
